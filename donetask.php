...
<?php require('inc/sidebar.php'); ?>
 ...
 if(isset($_GET['data-show'])) {
   ...
   <?php
$query="SELECT * FROM tbl_tasks WHERE deleted_at IS NOT NULL AND t_status='done'";
}
} else {
$query="SELECT * FROM tbl_tasks WHERE deleted_at IS NULL AND t_status='done'";
?>
     <div class="box-header">
       <div class="add_new col-md-11 col-sm-8 col-xs-8">
                ...
                $info=$_GET['data-show'];
                  if($info=='trashed') {
                    ?>
                      ...
                      <?php }} else {
                        ?>
                        <a href="process/softdeletetask.php?id=<?php echo $data['id']; ?>"><button type="button" class="btn btn-danger"><span><i class="fa fa-trash" aria-hidden="true"></i></span> Delete</button></a>
                        <?php
                      } ?>
                      </td>
                    </tr>
