 ...
 if(isset($_GET['data-show'])) {
   ...
   <div class="box-header">
     <div class="add_new col-md-11 col-sm-8 col-xs-8">
        &nbsp&nbsp<a href="tasks.php"><button type="button" class="btn btn-success"><span><i class="fa fa-refresh" aria-hidden="true"></i> </span> &nbspActive Lists</button></a>
     </div>
   </div>
   <?php
$query="SELECT * FROM tbl_tasks WHERE deleted_at IS NOT NULL";
}
} else {
$query="SELECT * FROM tbl_tasks WHERE deleted_at IS NULL";
?>
     <div class="box-header">
     <div class="add_new col-md-11 col-sm-8 col-xs-8">
       <a href="addtask.php"><h3 class="box-title"><button type="button" class="btn btn-block btn-info"><span><i class="fa fa-plus" aria-hidden="true"></i>&nbsp</span> Add Task</button></h3></a>
       ...
       &nbsp&nbsp<a href="donetask.php"><h3 class="box-title"><button type="button" class="btn btn-block btn-info"><span><i class="fa fa-check" aria-hidden="true"></i>&nbsp</span> Done Tasks</button></h3></a>
          &nbsp&nbsp<a href="tasks.php"><button type="button" class="btn btn-success"><span><i class="fa fa-refresh" aria-hidden="true"></i> </span> &nbspRefresh</button></a>
     </div>
     <div class="see_trash col-md-1 col-sm-4 col-xs-4">
       <a href="tasks.php?data-show=trashed"><h3 class="box-title"><button type="button" class="btn btn-block btn-danger"><span><i class="fa fa-trash" aria-hidden="true"></i>&nbsp</span> Trash</button></h3></a>
     </div>
   </div>
 <?php }
                ...
                $info=$_GET['data-show'];
                  if($info=='trashed') {
                    ?>
                      ...
                      <?php }} else {
                        ?>
                        <a href="process/seentask.php?id=<?php echo $data['id']; ?>"><button type="button" class="btn btn-primary"><span><i class="fa fa-check-square-o" aria-hidden="true"></i> Seen</span></button></a>
                        <?php
                      } ?>
                      </td>
                    </tr>
